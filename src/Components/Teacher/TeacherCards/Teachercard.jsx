...
export default function Teachercard() {
  return (
    <div className="container max-w-[1440px] m-auto h-[900px] xl:h-auto">
      <div className="relative p-[0px_0px_0px_50px] flex  justify-around mb-[80px] slider-item-our ">
      ...
      <div className="relative p-[0px_0px_0px_50px] flex  justify-around mb-[80px] slider-item-our ">
        <div className=" w-[300px] scs-ali teacher-card  mb-[40px]">
          <img
