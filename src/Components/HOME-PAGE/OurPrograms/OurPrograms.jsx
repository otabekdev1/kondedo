  ...
  return (
    ...
    >
      <div className={container}>
        ...
        <div className="slider-item-our pb-[10%] flex-wrap">
          <div className="w-[416px] scs-ali h-[539px] relative bg-[white] p-6 rounded-3xl mb-[40px]">
            ...
            <div className="box w-[368px] h-[78px] bg-[#00bbae]  rounded-xl text-[#424242] p-[16px_20px] flex justify-around">
              <div className="flex-col flex border-dashed border-r-2 text-[white] items-center pr-8">
                ...
                <h5 className="text-[18px]  font-medium text-center  ">age</h5>
              </div>
          ...
          <div className="w-[416px] scs-ali relative h-[539px] bg-[white] p-6 rounded-3xl mb-[40px]">
            <div className="img-box overflow-hidden">
              <img
                className="w-[368px] h-[245px] rounded-xl main-img"
